...
wasteland_notes_001 = (
    ...
    "Q.1 Q.17 T.3 # Q.12 Q.6 # R.11 R.12 R.13 T.18 # Q.5 Q.13 Q.8 Q.16 # T.2 T.31 T.7 A.8 # Q.3 # Q.1 Q.3 T.25"
    " # Q.6 T.13 Q.11 # Q.4 Q.6 # Q.11 Q.2 Q.9 # SURFACE",
    "EVERYONE # Q.2 Q.9 A.5 A.4 # A.7 Q.7 # A.6 A.2 Q.3 Q.14 R.3 T.27 R.5 T.28 # T.28 T.23 T.30 # R.7 A.4 A.5 A.4",
    "T.19 T.15 # T.9 T.17 R.13 T.20 T.14 # T.20 T.4 # T.6 T.29 T.23 T.50 # T.18 T.26 T.5"
    " # T.13 T.24 A.8 T.23 T.36 T.28 R.5 T.8"
    " T.5 T.7 A.8",
    "T.28 T.22 T.4 T.14 T.11 # Q.1 Q.6 A.5 Q.14 A.8 # Q.5 Q.6 Q.7 Q.8 Q.9 Q.10 Q.11 Q.20 T.35 # A.2 A.1"
    " # A.2 A.3 A.4 WRONG"
    " WORLD",
    "Q.1 Q.17 Q.20 Q.7 # T.25 Q.6 T.13 # A.8 A.7 A.9 # YOU # CAN'T # GET # OUT",
    "EVERY # WORLD # HAS # OWN # LAWS # THEY # JUST # HAVE # TO # BE # CORRECT # ONES",
    "T.9 T.22 T.19 T.11 T.29 # R.11 T.17 T.16 T.6 T.14 # T.20 T.22 T.23 T.18 # T.6 T.24 T.8 T.9 # Q.4 A.3 A.7 A.6"
    " # PLACE",
    ...
    "A.3 A.1 Q.1 # R.11 T.17 R.13 T.25 # T.11 T.10 R.11 R.4 T.14 # T.25 A.1 T.5 # R.7 R.12 T.36 R.4 # A.6 A.9 A.9 Q.7"
    " # A.2 A.3 A.7 A.6 # R.3 R.2 R.12 Q.5 T.6 # Q.1 Q.6 A.5 Q.14 A.8",
    "WITHOUT # THE # CORRECT # LAWS # NOTHING # STAYS # TOGETHER",
    "THE # MACHINE # Q.5 Q.3 T.27 Q.12 Q.9 Q.19 # A.7 A.2 # A.2 A.3 A.9 T.3 # A.8 A.1 Q.7 A.2 # T.6 Q.7 Q.6 Q.1"
    " # A.7 A.2",
    ...
    "T.28 T.26 T.35 # T.4 T.2 # R.11 T.1 R.13 R.4 R.5 T.14 # T.14 R.6 R.12 R.6 T.13 T.39 T.14 # T.31 R.13"
    " # R.11 T.10 R.13 R.4 T.14",
...
def _decode_wasteland_message(key: Dict[str, str], message: str, with_code: bool = False) -> str:
    ...
    return "".join(map(decode_word, message.split())).replace("#", " ")


def _clean_unreferenced_key_chars(key: Dict[str, str], messages: Tuple[str, ...]) -> Dict[str, str]:
...
if __name__ == "__main__":
    ...
    print(_clean_unreferenced_key_chars(wasteland_notes_001_key, wasteland_notes_001))
