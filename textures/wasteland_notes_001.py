...
wasteland_notes_001 = (
    ...
    (
        ...
        "R.11 R.12 R.13 T.18",
        "Q.5 Q.13 Q.8 Q.16 # T.2",
        "T.31 T.7 A.8 # Q.3 # Q.1 Q.3 T.25" "",
    ...
    (
        ...
        "T.13 T.24 A.8 T.23 R.36 T.28 R.5 T.8 T.5 T.7 A.8",
    ),
    (
    ...
    ("YOU # CAN", "GETTHERE # IF # YOU", "KNOW # HOW"),
)
