...
wasteland_notes = (
    ...
    "T.19 T.15 T.9 T.17 R.13 T.20 T.14 T.20 T.4 T.6 T.29 T.23 T.50 T.18 T.26 T.5 T.13 T.24 A.8 T.25 T.36 T.28 R.5 T.8 T.5 T.7 A.8",
    ...
    "A.3 A.1 Q.1 R.11 T.17 R.13 T.25 T.11 T.10 R.11 R.4 T.14 T.25 A.1 T.5 R.7 R.12 T.36 R.4 A.6 A.9 A.9 Q.3 A.2 A.3 A.7 A.6 R.3 R.2 R.12 Q.5 T.6 Q.1 Q.6 A.5 Q.14 A.8",
...
def decode_wasteland_message(key: Dict[str, str], message: str) -> str:
